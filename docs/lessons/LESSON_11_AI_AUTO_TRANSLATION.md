...
Siguiendo la arquitectura **Zero-Dependency**, se implementó un hook que usa `fetch` nativo hacia los endpoints de Google AI Studio, evitando librerías pesadas como el `@google/generative-ai`.
